...
public actor Session {
    ...
    init(
        deviceId: String,
        renderRegistry: SurfaceRenderHubRegistry,
        sendFrame: (@Sendable (PushFrame) -> Void)? = nil,
        sendOutput: (@Sendable (SessionOutboundFrame) -> Void)? = nil,
        sendOutputEvent: (@Sendable (SessionOutboundEvent) -> Void)? = nil
    ) {
