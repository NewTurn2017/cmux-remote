...
First, add the four M3-specific package dependencies that M1 stashed and M2 didn't need yet. Replace the MILESTONE-GATED comment in `dependencies:` with the live entries:
...
Then add the executable target and two new test targets:
