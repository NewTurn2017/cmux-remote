...
- [ ] Release archive + export for 1.0.7 build 10 (`aps-environment=production`, App Store distribution profile).
- [ ] `1.0.7 (10)` metadata re-verified for ASC field limits and URL liveness.
